<template>
  <div class="datail">
    ...
    <div class="detail_box">
      <div class="detaliimgbox">
        <img :src="productDetail.small_img" alt="" />
      </div>
      <div class="detailbox">
        <div class="detailbox2">
          ...
          <div class="rule-box">
            <div
              class="rule-items"
              v-for="item in productDetail.rules"
              :key="item.title"
            >
...
<script>
import "../assets/less/detail.less";import { Loading } from 'vant';
export default {
  name: "Detail",
  data() {
    return {
